...
export const IconMore = ({ size, className }: P): JSX.Element =>
  svg(
    <>
...
export const IconSettings = ({ size, className }: P): JSX.Element =>
  svg(
    <>
...
export const IconArrowUp = ({ size, className }: P): JSX.Element =>
  svg(
    <>
      <path d="M12 19V5" />
...
export const IconPlaylist = ({ size, className }: P): JSX.Element =>
  svg(
    <>
